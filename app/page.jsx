...
export default function Home() {
	return (
		<div className="flex flex-col items-center justify-center w-screen h-screen overflow-hidden bg-gradient-to-tl from-black via-zinc-600/20 to-black p-5">
			...
			<div className="my-16 text-center animate-fade-in space-y-2 text-2xl md:text-3xl">
				<h2 className="text-zinc-500 font-display">
					{data.subheading}
				</h2>
				<TypeAnimation />
			</div>
